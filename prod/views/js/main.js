...
var resizePizzas = function(size) { 
  ...
  // Set classname on #randomPizzas element to determine size of pizzas
...
var frame = 0;
var pizzaNodeList;
var totalPizzas = 30; // This will be set when DOMContentLoaded event fires based on rows * columns.
...
// I removed height and width styles from this function, setting them in style.css instead.
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Cache list of pizza elements for later referencing
