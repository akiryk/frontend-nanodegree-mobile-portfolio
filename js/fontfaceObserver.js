/**
 * From bramstein@github
 * https://github.com/bramstein/fontfaceobserver
 * 
 * Font Face Observer is a small @font-face loader and monitor 
 * (5.2KB minified and 1.9KB gzipped) compatible with any web font service. 
 * It will monitor when a web font is applied to the page and notify you. 
 * It does not limit you in any way in where, when, or how you load your web fonts. 
 * Unlike the Web Font Loader Font Face Observer uses scroll events to detect font loads 
 * efficiently and with minimum overhead.
 */
...
u();setTimeout(a,50)}}var D=Date.now();w(l,"sans-serif",k);w(m,"serif",k);w(n,"monospace",k);g.appendChild(l.a);g.appendChild(m.a);g.appendChild(n.a);document.body.appendChild(g);q=l.a.offsetWidth;r=m.a.offsetWidth;t=n.a.offsetWidth;a();y(l,function(a){d=a;u()});w(l,'"'+p.family+'",sans-serif',k);y(m,function(a){e=a;u()});w(m,'"'+p.family+'",serif',k);y(n,function(a){f=a;u()});w(n,'"'+p.family+'",monospace',k)})})};window.FontFaceObserver=z;window.FontFaceObserver.prototype.check=z.prototype.a;}());
 ...
 /*
  ...
  When fonts are loaded, we enable them by adding a class to the html element
  */
  (function( w ){
